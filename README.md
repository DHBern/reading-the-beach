...
This project was developed by [Sebastian Flick](https://github.com/flicksolutions) and [Katharina Scheller](https://github.com/schellerk). It is a static website currently hosted on Github Pages.
